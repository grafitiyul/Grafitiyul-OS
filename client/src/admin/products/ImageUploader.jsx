...
// NOTE: the per-variant quote Gallery that lived here was removed — variants no
// longer upload quote images; they reference the shared Quote Image Library
// (see VariantQuoteImages.jsx). SingleImage stays for genuine single-owner
// images (meeting point, quote hero/logo, library uploads).
